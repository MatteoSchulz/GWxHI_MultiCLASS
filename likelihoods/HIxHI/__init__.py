...
class HIxHI(Likelihood):
    ...
    def __init__(self, path, data, command_line):
        ...
        self.cl_file = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}{binned_str}_Cl.pkl'
        self.Cov_file = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}{binned_str}_Cov.pkl'
        self.InvCov_file = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}{binned_str}_InvCov.pkl'
        
        self.redshift_file = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}_{self.network}_zbin.pkl'
        self.redshift_filehi = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}_{self.network}_zbinhi.pkl'
        self.redshift_filegw = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}_{self.network}_zbingw.pkl'
        
        self.zedges_filehi = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}_{self.network}_zedgeshi.pkl'
        self.zedges_filegw = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}_{self.network}_zedgesgw.pkl'
        
        self.Ngw_file = f'dataset_HIxHI_{self.bias}_{self.method}_{self.nbins}_{self.network}_NgwBin.pkl'
